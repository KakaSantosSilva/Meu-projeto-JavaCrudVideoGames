...
public class VideoGamesDAO {
    ...
    public void cadastrarVideoGames(VideoGamesDTO objvideogamesdto){
        ...
        String sql = "insert into Games(dataCadastro,tipo_jogo,titulo_jogo,plataforma,midia,sinopse,statuss)values(?,?,?,?,?,?,'On')";
        
        conn = new ConexaoDAO().ConectaBD();
        
        try {
            pstm = conn.prepareStatement(sql);
            pstm.setString(1, objvideogamesdto.getData_cadastro());
            pstm.setString(2, objvideogamesdto.getTipo_jogo());
            pstm.setString(3, objvideogamesdto.getTitulo_jogo());
            pstm.setString(4, objvideogamesdto.getPlataforma());
            pstm.setString(5, objvideogamesdto.getMidia());
            pstm.setString(6, objvideogamesdto.getSinopse());
